...
if __name__ == '__main__':
    ...
    # tablica do bucket sorta z jednostajnym rozkładem
    tab2 = [0.78, 0.17, 0.39, 0.26, 0.72, 0.94, 0.21, 0.12, 0.23, 0.68]
    tab3 = [6.1, 1.2, 1.5, 3.5, 4.5, 2.5, 3.9, 7.8, 8.0]
    test = [12, 40, 38, 35, 6, 32, 52, 58, 57, 53, 5, 9, 68, 62, 9, 75, 43, 50, 5, 54, 51, 45, 17, 46, 16, 12, 72, 12, 45, 21,
    ...
    tablica = [1.072, 1.414, 1.149, 1.717, 1.007]
    #insert_sort(tab2)
    #print(tab2)
    #print(bucker_sort(test))
    #bucker_sort(test)
    #print(test)
